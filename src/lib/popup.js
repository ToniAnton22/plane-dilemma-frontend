export const popupString = (filter) =>{
    return( `<div class="flex-row-reverse overflow-hidden justify-center items-center align-center w-full h-full bg-linear-to-br variant-gradient-primary-secondary rounded-tr-full rounded-tl-full border-red-300 border-4 ">
