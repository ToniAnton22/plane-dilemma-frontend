...
{#each paginatedSource as npc}
    <a href="/home/npcs/npc/details?detail={encodeURIComponent(JSON.stringify(npc))}" class="card flex p-4 w-96 h-96 bg-cover bg-center bg-no-repeat border-2 border-black rounded-2xl shadow-2xl " style="background-image:url({npc?.avatar})">
